...
static const u8 sDoorAnimPalettes_DeltaLabB[] = {12, 12, 12, 12, 12, 12, 12, 12};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Fallarbor_Door_DeltaLab,                      DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_DeltaLab, sDoorAnimPalettes_DeltaLabB},
