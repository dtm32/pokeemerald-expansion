...
static const u8 sText_EvaporateMiss[] = _("{B_DEF_NAME_WITH_PREFIX} nullifies WATER\nmoves with {B_DEF_ABILITY}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_EVAPORATEMISS - BATTLESTRINGS_TABLE_START] = sText_EvaporateMiss,
...
const u16 gMissStringIds[] =
{
    ...
    [B_MSG_EVAPORATE_MISS] = STRINGID_EVAPORATEMISS
};
