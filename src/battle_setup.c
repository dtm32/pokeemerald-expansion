...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CHUCK] = REMATCH(TRAINER_CHUCK_1, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, DEWFORD_TOWN),
    ...
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_LAB_B_LILEEP, TRAINER_NORMAN_LAB_B_ANORITH, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_5, PETALBURG_CITY),
