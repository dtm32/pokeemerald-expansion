static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SLATEPORT_CITY - 1] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 39, 20},
    ...
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), 12, 11},
    [HEAL_LOCATION_LAVARIDGE_TOWN - 1] = {MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN), 15, 7},
    ...
    [HEAL_LOCATION_ZONE_A_WAREHOUSE_1F - 1] = {MAP_GROUP(ZONE_A_WAREHOUSE_1F), MAP_NUM(ZONE_A_WAREHOUSE_1F), 10, 10},
    [HEAL_LOCATION_BLEAKISLE_TOWN - 1] = {MAP_GROUP(BLEAKISLE_TOWN), MAP_NUM(BLEAKISLE_TOWN), 21, 7},
};
