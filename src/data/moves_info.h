...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_BRILLIANT_PUNCH] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("BrilliantPunch", "Brilliant Punch"),
        .description = COMPOUND_STRING(
            "A dazzling punch that\n"
            "may confuse the foe."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FAIRY,
    ...
    [MOVE_ANCIENT_EMBER] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("AncientEmber", "Ancient Ember"),
        .description = COMPOUND_STRING(
            "An attack that may raise\n"
            "all stats."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ANCIENT_VINE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("AncientVines", "Ancient Vines"),
        .description = COMPOUND_STRING(
            "An attack that may raise\n"
            "all stats."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ANCIENT_FLOOD] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("AncientFlood", "Ancient Flood"),
        .description = COMPOUND_STRING(
            "An attack that may raise\n"
            "all stats."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ANCIENT_SPARK] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("AncientSpark", "Ancient Spark"),
        .description = COMPOUND_STRING(
            "An attack that may raise\n"
            "all stats."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ROCK_CANNON] =
    {
        .name = COMPOUND_STRING("Rock Cannon"),
        .description = COMPOUND_STRING(
            "Rockets a boulders at the\n"
