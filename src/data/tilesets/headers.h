...
const struct Tileset gTileset_OldChateau =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_OldChateau,
    .palettes = gTilesetPalettes_OldChateau,
    .metatiles = gMetatiles_OldChateau,
    .metatileAttributes = gMetatileAttributes_OldChateau,
    .callback = NULL,
};
