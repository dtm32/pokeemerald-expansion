...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_TORRENT, ABILITY_NONE, ABILITY_STEELY_SPIRIT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_NO_GUARD, ABILITY_INTIMIDATE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Luxio"),
        .cryId = CRY_LUXIO,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_ARENA_TRAP, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .abilities = { ABILITY_DRIZZLE, ABILITY_SWIFT_SWIM, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LUMINEON] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 168 : 156,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
